...
git clone https://github.com/SyChell/gpt-rag-ingestion ./.azure/gpt-rag-ingestion
...
# Clone the repository into the .azure folder
git clone https://github.com/SyChell/gpt-rag-orchestrator ./.azure/gpt-rag-orchestrator
...
# Clone the repository into the .azure folder
git clone https://github.com/SyChell/gpt-rag-frontend ./.azure/gpt-rag-frontend
